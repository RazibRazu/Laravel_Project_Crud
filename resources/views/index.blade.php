...
<html lang="en">
  ...
  <body class="bg-green-100 py-10">
    <div class="max-w-7xl mx-auto p-6 sm:px-8 lg:px-10 bg-white shadow-md rounded-md">
    <div class="flex justify-between items-center mb-6">
      <!-- Header -->
      <h1 class="text-3xl font-bold text-orange-800 mb-6">Laravel Project</h1>

      <!-- Create Product Button -->
      <div class="flex justify-end mb-4">
        <a
          href="{{ route('products.create') }}"
          class="flex items-center px-4 py-2 bg-orange-600 text-white text-sm font-medium rounded shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600">
